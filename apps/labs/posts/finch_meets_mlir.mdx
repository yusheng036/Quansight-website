...
- [TOSA](https://mlir.llvm.org/docs/Dialects/TOSA/#tosa-and-tensor-level-expressiveness) dialect represent tensor computations common in machine learning.
...
This article presents my thoughts and understanding of MLIR. If you are interested in exploring my contributions, they are summarized in two pull requests:
...
In the graph above, we see a MLIR speedup graph against Numba against the various scientific computing kernels. We see a noticeable improvement in most of the kernels except for the Hadamard multiplication kernel. This proves that MLIR is the preferred backend in finch-tensor for most scientific computing kernels.
...
and researchers can finally test the performance of finch-tensor on gpu hardwares. There are not many sparse tensor libraries on the market that provide
...
I am excited at the potential that my contributions have opened up to.
